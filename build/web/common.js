...
function buildSMS(number, body) {
	// encode the body string (replace any & in the body with + or it will terminate the body string, = next parameter; likewise )
	return "sms://" + (number ? number : "") + (body ? (isIOS() ? "&" : "?") + "body=" + encode(body) : "");
